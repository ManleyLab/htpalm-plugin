 ...
 */
public class TempDialog extends javax.swing.JDialog implements MMListenerInterface{

   //TODO: Make current position / current FOV update automatically
   //TODO: Add nFov config parameter
   TempMMPlugin htpalm =null;
    ...
    */
   public TempDialog(java.awt.Frame parent, boolean modal, ConfigurationOptions config_, HardwareControl control_, TempMMPlugin htpalm) {
      super(parent, modal);
      initComponents();
   ...
   private void jButton_LoadSettingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoadSettingsActionPerformed
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
         try {
            ...
            Logger.getLogger(TempDialog.class.getName()).log(Level.SEVERE, null, ex);
         }
      } else {
