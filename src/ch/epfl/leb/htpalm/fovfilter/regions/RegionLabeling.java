...
public abstract class RegionLabeling {
	...
	protected final int BACKGROUND = 0;
	protected final int FOREGROUND = 1;
	protected final int START_LABEL = 2;
	/**
    * Java array containing label image
    * Made protected SH121026
    */
