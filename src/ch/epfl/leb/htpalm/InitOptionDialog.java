...
public class InitOptionDialog extends javax.swing.JDialog {
   ...
   private void reloadSettings(){
      ...
      jTextField_MosaicNRepeats.setText(Integer.toString(newConfig_.getMosaicNRepeats_()));
      ...
      jTextField_CamAutoFocusDelayTimeMs.setText(Double.toString(newConfig_.getCamAutoFocusDelayTimeMs_()));
   ...
   private void updateSettings(){
      ...
      newConfig_.setMosaicNRepeats_(Integer.parseInt(jTextField_MosaicNRepeats.getText()));
      ...
      newConfig_.setCamAutoFocusDelayTimeMs_(Double.parseDouble(jTextField_CamAutoFocusDelayTimeMs.getText()));
   ...
   private void initComponents() {
      ...
      jLabel_MosaicNFov1 = new javax.swing.JLabel();
      jTextField_MosaicNRepeats = new javax.swing.JTextField();
      ...
      jTextField_CamAutoFocusDelayTimeMs = new javax.swing.JTextField();
      jLabel_PhCamDelayTime1 = new javax.swing.JLabel();
      ...
      jLabel_MosaicNFov1.setText("Number of repeats:");
      jLabel_MosaicNFov1.setToolTipText("Number of fields of view to be acquired");
      ...
      jPanel1Layout.setHorizontalGroup(
         ...
         .add(jPanel1Layout.createSequentialGroup()
            ...
            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               ...
               .add(jLabel_MosaicNFov1))
            .add(36, 36, 36)
            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               .add(jTextField_MosaicNRepeats, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 45, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
      ...
      jPanel1Layout.setVerticalGroup(
         ...
         .add(jPanel1Layout.createSequentialGroup()
            ...
            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               .add(jLabel_MosaicNFov1)
               .add(jTextField_MosaicNRepeats, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
      ...
      jLabel_PhCamDelayTime.setText("Inter-movie delay time (ms):");
      ...
      jTextField_CamAutoFocusDelayTimeMs.setHorizontalAlignment(javax.swing.JTextField.TRAILING);

      jLabel_PhCamDelayTime1.setText("Autofocus delay time (ms):");
      jLabel_PhCamDelayTime1.setToolTipText("Time to wait after PH acquisition");
         ...
         .add(jPanel4Layout.createSequentialGroup()
            ...
            .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               .add(jPanel4Layout.createSequentialGroup()
                  ...
                  .add(90, 90, 90)
                  .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(jTextField_EmccdExposureTime, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
                     .add(jTextField_EmccdCamName)))
               .add(jPanel4Layout.createSequentialGroup()
                  .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(jLabel_PhCamName)
                     .add(jLabel_PhExposureTime)
                     .add(jLabel_PhCamDelayTime)
                     .add(jLabel_PhCamDelayTime1)
                     .add(jLabel_EmccdNumFrames))
                  .add(65, 65, 65)
                  .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(jTextField_EmccdNumFrames)
                     .add(org.jdesktop.layout.GroupLayout.TRAILING, jTextField_CamAutoFocusDelayTimeMs)
      ...
      jPanel4Layout.setVerticalGroup(
         ...
         .add(jPanel4Layout.createSequentialGroup()
            ...
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
               .add(jTextField_CamAutoFocusDelayTimeMs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
               .add(jLabel_PhCamDelayTime1))
   ...
   private javax.swing.JLabel jLabel_MosaicNFov1;
   private javax.swing.JLabel jLabel_PhCamDelayTime;
   private javax.swing.JLabel jLabel_PhCamDelayTime1;
   ...
   private javax.swing.JTextField jTextField_CamAutoFocusDelayTimeMs;
   ...
   private javax.swing.JTextField jTextField_MosaicNRepeats;
